...
abstract class AdminDashBoardAdapter(options: FirebaseRecyclerOptions<model?>) :
    ...
    override fun onBindViewHolder(holder: Viewholder, position: Int) {
        ...
        holder.cancleBtn!!.setOnClickListener { view ->
            //Getting user id from the gmail sign in
        ...
        holder.acceptBtn!!.setOnClickListener { view ->
            ...
            //Adding Notification to database
            FirebaseDatabase.getInstance().reference.child("UserNotifications").child(model().userId!!)
                .child(pushKey!!)
                .child("notification")
                .setValue("Your Request for Book " + model().bookName + " is Accepted By Admin")
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): AdminDashBoardAdapter.Viewholder {
